...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application( application: UIApplication, didRegisterForRemoteNotificationsWithDeviceToken deviceToken: NSData ) {
        ...
        let faghelgApi = FaghelgApi(managedObjectContext: managedObjectContext)
    ...
    func application(application: UIApplication, didReceiveRemoteNotification userInfo: [NSObject : AnyObject], fetchCompletionHandler completionHandler: (UIBackgroundFetchResult) -> Void) {
        ...
        let message = Message.fromPushPayload(userInfo, insertIntoManagedObjectContext: managedObjectContext)
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "no.mesan.TestCoreData" in the application's documents Application Support directory.
